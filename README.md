...
Для загрузки мест в базу данных используйте команду `load_place`. 
Она принимает URL или путь к локальному JSON-файлу.

### Загрузка по URL (рекомендуется)

Ссылка на репозиторий с "местами" https://github.com/Andrey9045/Places

```
python manage.py load_place https://raw.githubusercontent.com/Andrey9045/where_to_go/main/places/roofs24.json
```

### Загрузка из локального файла
```
# Скачайте JSON-файл
curl -o anticafe.json https://raw.githubusercontent.com/Andrey9045/where_to_go/main/places/roofs24.json

# Загрузите его
python manage.py load_place anticafe.json
```
### Пример json файла
```
{
